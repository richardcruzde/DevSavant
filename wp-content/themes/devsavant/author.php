...
add_action( 'genesis_before_content', 'therapetic_author_top_page' );
//add_action( 'genesis_loop', 'therapetic_author_loop' );

$author_id = get_the_author_ID();


function  therapetic_author_top_page() {
...
function therapetic_author_loop() {
    ?>
